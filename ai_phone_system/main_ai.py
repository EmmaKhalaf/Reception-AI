...
DATABASE_URL = os.getenv("DATABASE_URL")import os
import psycopg2
from fastapi import FastAPI, Request
from fastapi.responses import Response
from fastapi.middleware.cors import CORSMiddleware
...
# ============================================================
# TEMPORARY IN-MEMORY STORAGE (still used for now)
# ============================================================
...
# ============================================================
# RESCHEDULE APPOINTMENT (DATABASE)
# ============================================================
